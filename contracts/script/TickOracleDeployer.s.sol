...
import {TickOracleDeploymentLib} from "./utils/TickOracleDeploymentLib.sol";
...
contract TickOracleDeployer is Script {
    ...
    TickOracleDeploymentLib.DeploymentData helloWorldDeployment;
    ...
    function run() external {
        ...
        helloWorldDeployment = TickOracleDeploymentLib.deployContracts(
            proxyAdmin,
            coreDeployment,
            quorum
        );
        ...
        verifyDeployment();
        TickOracleDeploymentLib.writeDeploymentJson(helloWorldDeployment);
    }
    ...
    function verifyDeployment() internal view {
        ...
        require(
            helloWorldDeployment.tickOracleServiceManager != address(0),
            "tickOracleServiceManager address cannot be zero"
        );
        require(
            helloWorldDeployment.strategy != address(0),
